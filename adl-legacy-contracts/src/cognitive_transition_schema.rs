...
mod tests {
    ...
    const WP04_TRANSITION_DAG_PACKET: &str =
        include_str!("../fixtures/ct_demo_001_transition_dag.md");
    const WP04_SHARD_PLAN_PACKET: &str = include_str!("../fixtures/ct_demo_001_shard_plan.md");
    const WP05_EVIDENCE_BUNDLE_PACKET: &str =
        include_str!("../fixtures/ct_demo_001_evidence_bundle.md");
    const WP05_REVIEW_SYNTHESIS_PACKET: &str =
        include_str!("../fixtures/ct_demo_001_review_synthesis.md");
    const WP06_MERGE_GATE_PACKET: &str = include_str!("../fixtures/ct_demo_001_merge_gate.md");
    const WP07_OBSMEM_HANDOFF_RECORD: &str =
        include_str!("../fixtures/ct_demo_001_obsmem_handoff.json");
    const WP07_OBSMEM_HANDOFF_PACKET: &str =
        include_str!("../fixtures/ct_demo_001_obsmem_handoff.md");
