...
pub struct AcipProofDemoPacketV1 {
    ...
    pub local_review_exchange: AcipLocalInvocationExchangeV1,
    pub local_coding_exchange: AcipLocalInvocationExchangeV1,
    pub denied_route_exchange: AcipLocalInvocationExchangeV1,
