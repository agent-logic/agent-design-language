...
grep -Fq "ISSUE_LIFECYCLE_SHEPHERD_CONTRACT.md" "${skills_root}/docs/OPERATIONAL_SKILLS_GUIDE.md"
...
grep -Fq "lifecycle_shepherd" "${skills_root}/workflow-conductor/references/output-contract.md"
