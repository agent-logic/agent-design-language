...
DEFAULT_SKIP_PATTERNS="real_pr_,runtime_v2_runtime_inhabitant_integration_,runtime_v2_theory_of_mind_foundation_,runtime_v2_unified_runtime_kernel_,csmctl_authenticated_api_client_waits_for_slow_listener_startup"
