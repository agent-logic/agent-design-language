...
run_contracts() {
  ...
  rg -q 'measured_before_mutation:true' "$ROOT/infra/aws/runtime/gpu-proof/warm-storage/preparation/runtime-user-data.sh.tftpl"
  rg -q 'measured_before_mutation:true' "$ROOT/infra/aws/runtime/gpu-proof/warm-storage/preparation/gpu-user-data.sh.tftpl"
  ...
  rg -q 'adl.issue607.authorization.v2' "$ROOT/adl/tools/run_issue607_warm_polis.sh"
