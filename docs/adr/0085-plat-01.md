# ADR 0085: Shared provider configuration and lifecycle
...
- [docs/adr/0004-provider-profiles.md](0004-provider-profiles.md)
- [docs/adr/0041-provider-model-suitability-boundary-v2.md](0041-provider-model-suitability-boundary-v2.md)
- [docs/architecture/adr/0075-provider-profile-and-shadow-authority.md](../architecture/adr/0075-provider-profile-and-shadow-authority.md)
...
Accepted clarification: Separate configuration candidate validation, immutable registered definition replacement and runtime agent operations. Keep capability lists and five-route execution as required qualification rather than infer them from registry types.
...
Acceptance evidence: [operator decisions](../milestones/v0.92.2/adr/issue-945/operator-decisions.json). Original proposal: [ADR-PLAT-01](../architecture/adr/issue-911/adr-plat-01.md).
