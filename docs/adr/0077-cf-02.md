# ADR 0077: Evidence, finding and run identity
...
Accepted clarification: Keep stable match identity separate from revision-bound evidence identity and report identity; contract validation is not proof of a complete installed consumer journey.
...
Acceptance evidence: [operator decisions](../milestones/v0.92.2/adr/issue-945/operator-decisions.json). Original proposal: [ADR-CF-02](../architecture/adr/issue-911/adr-cf-02.md).
