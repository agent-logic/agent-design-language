# ADR 0082: Longitudinal comparison and Memory Palace
...
- [docs/adr/0058-memory-palace-context-handoff-architecture.md](0058-memory-palace-context-handoff-architecture.md)
...
Acceptance evidence: [operator decisions](../milestones/v0.92.2/adr/issue-945/operator-decisions.json). Original proposal: [ADR-CF-07](../architecture/adr/issue-911/adr-cf-07.md).
