# ADR 0078: Untrusted input, redaction and retention
...
Accepted clarification: Specify bounded known-unsafe whole-object omission rather than imply comprehensive secret discovery, arbitrary text sanitization or retroactive purge of already exported copies.
...
Acceptance evidence: [operator decisions](../milestones/v0.92.2/adr/issue-945/operator-decisions.json). Original proposal: [ADR-CF-03](../architecture/adr/issue-911/adr-cf-03.md).
