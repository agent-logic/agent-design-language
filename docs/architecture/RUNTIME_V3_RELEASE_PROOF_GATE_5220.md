...
`cutover_eligible: false` with three remaining blocker-class capability groups
after #5277, #5278, #5279, #5280, #5281, and #5284, so Runtime v2 remains the default
...
| Live black-box parity | `docs/architecture/runtime_v3_live_black_box_parity_5248.v1.json` | `cutover_eligible: false`; three blockers remain for default replacement after #5277, #5278, #5279, #5280, #5281, and #5284. |
...
| Live black-box parity | blocked for default cutover | #5248 remains `cutover_eligible: false`; #5220 closes as no-go for default cutover. |
...
- Runtime v3 is not full default-cutover-ready behavioral parity; three
