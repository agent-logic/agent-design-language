...
`cutover_eligible: false` with four remaining blocker-class capability groups
after #5277, #5278, #5279, #5280, and #5284, so Runtime v2 remains the default
...
| Live black-box parity | `docs/architecture/runtime_v3_live_black_box_parity_5248.v1.json` | `cutover_eligible: false`; four blockers remain for default replacement after #5277, #5278, #5279, #5280, and #5284. |
...
- Runtime v3 is not full default-cutover-ready behavioral parity; four
