...
sprint proofs #5277, #5278, #5279, #5280, #5281, and #5284 reduce the remaining
blocker-class capability groups to three without authorizing a default switch.
...
|---|---|---|
| Live black-box parity | `docs/architecture/runtime_v3_live_black_box_parity_5248.v1.json` | `cutover_eligible: false`; three blocker-class capabilities remain after #5277, #5278, #5279, #5280, #5281, and #5284. |
