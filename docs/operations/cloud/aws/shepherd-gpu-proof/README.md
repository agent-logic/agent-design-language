...
`adl-runtime-kernel`, and `adl-resilience` build/proof trees. This is the full
local Rust path-dependency closure required by the Runtime proof while avoiding
unrelated repository media and historical evidence. The Runtime bootstrap passes
