...
| Reasoning graph, loop runtime, and `adl.skill.v1` | Bounded implementation/proof retained | closed `#4694`-`#4697`, WP-11 review and cognitive-control evidence packets, and follow-ons `#4912`, `#5096`, `#5136` | Bounded producer/consumer/runtime proof exists; full adaptive-learning and final-standard convergence remain later work. |
