...
- WP-17 predecessor gate: fixed and passing.
- Current release-tail entrypoint truth: fixed and passing.
- Mandatory specialist lane runner: fixed and passing.
- Runtime API advertised endpoint truth: fixed and passing.
