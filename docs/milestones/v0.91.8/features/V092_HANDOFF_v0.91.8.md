...
WP-17 `#5360` owns the current documentation alignment to WP-16; WP-18 and
formal review remain later work. `#5355` owns the future v0.91.8 WP-21A handoff
review alignment, and `#5359` owns release-tail closeout truth. Do not confuse
future v0.91.8 WP-21A `#5355` with current v0.91.7 WP-21A `#5489`.
...
approval, WP-18 review completion, or v0.92 birthday readiness.
