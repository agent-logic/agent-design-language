...
| --- | --- | --- | --- | --- |
| Repository README | [../../../README.md](../../../README.md) | Names v0.91.8 as the active bridge, the completed review/remediation sequence, WP-23 as the current ceremony, and v0.92 as downstream. | Current entrypoint | Must not retain v0.91.7 as current or claim the release is published before ceremony verification. |
| README | [README.md](README.md) | Names the completed quality, documentation, review, remediation, handoff, and planning gates with WP-23 as the remaining release ceremony. | Current release-tail entrypoint | Must link this inventory and distinguish ceremony readiness from a published release. |
...
| Execution readiness | [WP_EXECUTION_READINESS_v0.91.8.md](WP_EXECUTION_READINESS_v0.91.8.md) | Records predecessor completion through WP-22 and the active WP-23 ceremony. | Current release-tail readiness | Must not mark the release published before tag and GitHub release verification. |
...
| Third-party review handoff | [review/THIRD_PARTY_REVIEW_HANDOFF_v0.91.8.md](review/THIRD_PARTY_REVIEW_HANDOFF_v0.91.8.md) | WP-19 external review is complete and WP-20 remediation is merged; WP-23 consumes that closed review sequence. | Completed release-tail evidence | Must preserve exact-revision and landed implementation/proof identities. |
...
| Release notes | [RELEASE_NOTES_v0.91.8.md](RELEASE_NOTES_v0.91.8.md) | Final ceremony input derived from merged v0.91.8 evidence with future-work non-claims retained. | Ceremony-ready | Must remain unchanged between reviewed WP-23 merge, tag creation, and release publication. |
...
| v0.92 closeout plan | [NEXT_MILESTONE_CLOSEOUT_PLAN_v0.91.8.md](NEXT_MILESTONE_CLOSEOUT_PLAN_v0.91.8.md) | WP-21A `#5355` prepares the operational closeout-planning packet after WP-21 `#5362` live merge truth. PR #5807 merged exact head `f1ddeacf5e91a1c8da690b2940e4125937aa57a3` as squash merge `eaa62d3d2c0241bc07ce827fedef0e42389d0491`, and #5362 is closed. | GitHub prerequisite satisfied; `origin/main` ancestry remains a consumer check | Must not require typed closeout receipts as downstream planning blockers or claim release ceremony completion. |
...
| WP-21A closeout plan linked | `rg "NEXT_MILESTONE_CLOSEOUT_PLAN_v0.91.8.md" docs/milestones/v0.91.8/README.md docs/milestones/v0.91.8/CANONICAL_DOC_INVENTORY_v0.91.8.md docs/milestones/v0.91.8/NEXT_MILESTONE_HANDOFF_v0.91.8.md docs/milestones/v0.91.8/features/V092_HANDOFF_v0.91.8.md` | Closeout planning is reachable from canonical release-tail entrypoints. |
