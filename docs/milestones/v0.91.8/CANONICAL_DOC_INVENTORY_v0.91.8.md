...
WP-01 #5594 reconciles this inventory before implementation. WP-21A #5355
fails closed at the release tail if any required canonical document or feature surface is
...
- WP-01 is `#5594`; milestone sprint umbrella `#5595` owns the complete wave.
...
| --- | --- | --- | --- | --- |
| Repository README | [../../../README.md](../../../README.md) | Names v0.91.8 as active bridge, #5594 opening readiness, #5595 sprint umbrella, and v0.92 downstream. | Current entrypoint | Must not retain v0.91.7 as active or claim implementation readiness. |
| README | [README.md](README.md) | Names #5594 active WP-01, #5595 sprint umbrella, historical #5335/#5383, #5384 WP-14A, #4641 restored v0.91.7 WP-14, and v0.92 downstream bridge. | Planned only | Must link this inventory and not claim release readiness. |
...
| Execution readiness | [WP_EXECUTION_READINESS_v0.91.8.md](WP_EXECUTION_READINESS_v0.91.8.md) | #5594 active; #5336 recovery; WP-10A and Runtime parity order; WP-13 waits on #5358/#5361 acceptance. | Planned only | Must not mark waiting WPs ready without proof. |
| WP-01 readiness report | [review/V0918_WP01_EXECUTION_READINESS_5594.md](review/V0918_WP01_EXECUTION_READINESS_5594.md) | Records live reconciliation, sprint topology, collision risks, and ready/not-ready dispositions. | Current WP-01 evidence | Must be reviewed at exact revision before WP-01 closes. |
...
| C-SDLC v2 acceptance | [features/CSDLC_V2_ACCEPTANCE_v0.91.8.md](features/CSDLC_V2_ACCEPTANCE_v0.91.8.md) | #5358, #5540, #5541, #5548, #5558 | Typed v2 lifecycle authority only; defects remain independently owned acceptance inventory. | Must require exact-revision lifecycle proof and defect disposition. |
