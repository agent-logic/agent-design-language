...
| Reasoning graphs, loops, affect control, and adaptive cognition | #5592, #5107 | `handoff_owned`: consume `docs/milestones/v0.91.8/FEATURE_PROOF_COVERAGE_v0.91.8.md` and the downstream Adaptive Learning DAG owner #5107; no activation readiness may be claimed until #5592/#5107 supply proof or explicit disposition. |
| Governed runtime operations | #5589 | `handoff_owned`: #5589 remains the Runtime v3 Parity-C owner for production adapter, identity/private-state, provider/scheduler, checkpoint, and lifelog proof before activation consumption. |
| Secure local/remote access and HTML Observatory | #5590 | `handoff_owned`: #5590 remains the Runtime v3 Parity-D owner for configuration-driven HTTPS, authenticated HTTP/WebSocket consumption, guardian, telemetry, and rollback proof. |
...
| Birth witnesses/receipt | #4762 | `handoff_owned`: #4762 is the direct downstream consumer for auditable birth-witness and receipt packaging and must cite this #4759 bridge after merge. |
