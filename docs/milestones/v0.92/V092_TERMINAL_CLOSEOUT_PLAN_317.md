...
|---|---:|---:|---|
| Sprint 6 | #5856 | #307 | coordination-only quality and release-tail umbrella |
| WP-20 | #5840 | #308 | demo matrix and proof coverage |
| WP-21 | #5786 | #309 | repository reduction |
| WP-21A | #5841 | #310 | Rust refactoring |
| WP-22 | #5842 | #311 | quality gate |
| WP-23 | #5843 | #312 | documentation truth |
| WP-25 | #5846 | #313 | internal review |
...
This 13-row set is the complete canonical Sprint 6 child/supporting/release
universe derived from the tracked wave and Sprint 6 packet. It is intentionally
not the unrelated 131-issue `version:v0.92` label set. The machine-readable denominator is
...
validation. Every row also states typed-record availability, phase, receipt,
branch/worktree, cleanliness, cleanup, release-dependency, owner, and next-action
truth, including explicit asynchronous or not-applicable classifications.

## Execution Gates

1. #316 / PR #472's independently reviewed revision is
   `d9aaaadbf5fc8e425e7099485fc006857feffd1e`. The later publication-metadata
   head is `8478f11e21a34530ba07bf64afc260e7a6eedd33`. The validator proves the
   reviewed revision is ancestral to that live PR head, its routed checks are
   green, and merge `5002b387b79f2d8dbf41a8c1a99e5a03bcb5c5d5` is ancestral to `main`.
...
GitHub issue and closing-PR state and retains the raw JSON responses under
`.csdlc/evidence/317/github-raw/` plus a bounded manifest containing:
...
retained envelope, raw response bytes, and tracked repository state. They
recompute every raw-response SHA-256 before parsing it, bind the envelope's
exact digest, reconcile canonical issue bodies with tracked legacy planning,
and reject arbitrary hex or self-bound replacement JSON. Independent review is
bound to tracked C-SDLC evidence; later publication-only commits are separately
named and must descend from the reviewed revision.

## Current Disposition

| Issue | Classification | Owner | Next action |
|---:|---|---|---|
| #307 | open coordination | Sprint 6 | reconcile only after ceremony; never gate children |
| #308 | reviewed green merged | WP-20 | retain proof input |
| #309 | reviewed green merged | WP-21 | retain proof and rollback copy |
| #310 | recordless merged | WP-21A | WP-29 independently verifies missing tracked review evidence |
| #311 | reviewed green merged | WP-22 | reconcile missing receipt/topology asynchronously |
| #312 | reviewed green merged | WP-23 | retain documentation truth |
| #313 | reviewed green merged | WP-25 | retain review findings |
...
identity, missing required receipt, active or dirty supposedly-clean worktree,
duplicate mutation, or any finish/cleanup/bookkeeping node used as a gate. The
negative lane executes 19 one-field mutations covering all of these classes,
including an arbitrary self-bound envelope digest.
