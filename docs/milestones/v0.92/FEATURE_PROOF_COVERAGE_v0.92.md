...
| Agent Logic repository copies | WP-02 | Source-before/destination-after/source-after manifests, Git/LFS parity, destination configuration checks, and source-immutability verification | planned |
