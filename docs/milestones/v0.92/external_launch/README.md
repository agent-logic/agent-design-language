...
- Last dependency check: `2026-07-31`; GitHub issue `#4762` was still open
...
publish. External use remains gated until the witness and receipt package from
`#4762` is accepted at an exact result and the launch owner records current
review truth.
...
| Activation bridge ledger row | `../V092_ACTIVATION_BRIDGE_LEDGER_v0.92.md` | v0.92 activation reviewers | Records that public launch docs are implemented but publication remains blocked on `#4762`. |
...
the repo. It does not provide final birthday proof because `#4762` has not yet
supplied accepted witness/receipt evidence.

The correct public posture is therefore:

> ADL has prepared the first-birthday launch surface and review boundary. The
> birthday itself remains pending until the witness and receipt proof is
> accepted.
