...
- All 31 creation-owned v0.92.1 issues each own one bounded objective, one
  primary deliverable, and one independently verifiable result.
...
The review found variant and bundled release-tail planning descriptions. The
four owned planning surfaces now use the exact canonical titles and separate
issue-local results. TAIL-06 owns the finding-disposition ledger. TAIL-10 owns
the operator-authorized release ceremony receipt; validation, cleanup, and
