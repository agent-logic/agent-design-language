...
The denominator is 45 rows: the prior 43-row inventory plus the unassigned OBS-S3 and ARCH-ADR work packages. Resolve WP-01's conductor separately; it is not its own creation target. Then reconcile 44 remaining rows: 43 prospective creations (requiring separate authorization) and one existing issue, #720. #525 creates none of them.
