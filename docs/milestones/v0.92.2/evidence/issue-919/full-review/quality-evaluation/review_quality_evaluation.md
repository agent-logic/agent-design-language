...
- Status: fail
- Score: 0
- Publication intent: internal_review_report
...
- Specialist Coverage: pass
- Template Compliance: pass
- Unsupported Claims: fail

## Blocking Issues

- unsupported_claim: Unsupported claim appears in final_report.md line 5: approval
...
- Present roles: code, security, tests, docs, architecture
- Missing roles: none
...
- unsupported_claim: **Changes required.** The current register contains27 findings:4 P1,20 P2 and3 P3. Four aggregate remediation issues are being coordinated; individual findings retain distinct proo Source: final_report.md.
...
- Publication allowed by source manifest: true.
