...
Status: requirements retained; component evidence is indexed in the [review handoff](../evidence/issue-917/HANDOFF.md), with final Beta 1 qualification pending. Owners: CF-PROOF and CF-INTEGRATE.
...
Both hosted website and installed-local-agent website journeys, invitation-only GitHub access and CLI support are required. Merged integration and 154 native/141 website passing checks do not replace #915 independent provider, fresh-user, platform and rendered-artifact acceptance.
