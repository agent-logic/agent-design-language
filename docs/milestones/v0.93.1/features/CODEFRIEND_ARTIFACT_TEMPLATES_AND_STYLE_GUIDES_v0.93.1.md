...
Reconciled draft under #922. Operator-confirmed v0.93.1 scope; no implementation, milestone opening or release acceptance claimed.
...
Template: feature_doc 1.1.0. Milestone: v0.93.1. Authoring issue: #922.
...
Follow accepted v0.92.2 closure, explicit v0.93.1 opening and RD-11 repository-split acceptance. Early #922 drafting does not satisfy final #921 handoff.
...
Only explicitly excluded scope may be deferred; the admitted v0.93.1 results remain release requirements.

## Notes

[Execution plan](../EXECUTION_PLAN_v0.93.1.json) is the dependency authority; [feature proof coverage](../FEATURE_PROOF_COVERAGE_v0.93.1.md) records feature mappings.
