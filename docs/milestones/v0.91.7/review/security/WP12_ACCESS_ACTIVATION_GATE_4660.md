...
| CAV red/blue claims require retained scenario evidence | fail_closed | Adversarial readiness remains blocked until `#4914` records red/blue runtime proof or an operator-approved non-claim. |
...
| CAV red/blue runtime proof | `#4914` | `blocked_with_evidence` | owner issue remains open; do not claim adversarial readiness |
...
- `#4914` remains open and cannot support CAV red/blue readiness claims.
