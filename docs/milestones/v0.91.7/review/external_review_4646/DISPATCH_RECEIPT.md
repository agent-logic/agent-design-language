...
This receipt is outside `REVIEW_CORPUS.v1.txt` and identifies the prior,
immutable target revision. This dispatch-only update does not mutate the
reviewed revision or its digest.
