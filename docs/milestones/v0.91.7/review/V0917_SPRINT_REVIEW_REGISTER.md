...
| WP-07A CSM runtime rearchitecture and topology sprint | #5121 closed; remediation implemented under #5409/#5494, exact-revision re-review pending | `docs/reviews/v0.91.7/remaining-sprints-5403/WP07A_REARCHITECTURE_REVIEW_5121.md`; `docs/review-fixes/runtime/WP07A_REARCHITECTURE_REPAIR_5409.md` | The corrective implementation now reports the actual daemon-supervised-cycle model, derives readiness from all required CSM component and policy-required typed-channel observations, runs the shared production cycle for 100 real ticks with injected failure/recovery, and provides bounded credential overlap plus expired-generation recovery and terminal revocation. Runtime v3 retains separate weather ownership. The umbrella remains setup/topology evidence only. | Close #5409 only after #5494 exact-revision re-review, proving validation, merge, and lifecycle closeout. |
