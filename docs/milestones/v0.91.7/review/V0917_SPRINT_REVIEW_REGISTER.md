...
| WP-07A CSM runtime rearchitecture and topology sprint | #5121 closed; #5409/#5494 remediation review-clean, merge/closeout pending | `docs/reviews/v0.91.7/remaining-sprints-5403/WP07A_REARCHITECTURE_REVIEW_5121.md`; `docs/review-fixes/runtime/WP07A_REARCHITECTURE_REPAIR_5409.md` | The corrective implementation reports the actual daemon-supervised-cycle model, derives readiness from all required CSM component and policy-required typed-channel observations, runs the shared production cycle for 100 real ticks with injected failure/recovery, and provides serialized bounded credential overlap, expired-generation recovery, and monotonic terminal revocation. Runtime v3 retains separate weather ownership. Exact-revision review dispositioned all eight findings as fixed. The umbrella remains setup/topology evidence only. | Close #5409 only after #5494 merge and lifecycle closeout. |
