...
- WP-08 is closed with retained runtime AWS/signal proof and closeout truth;
  ...
  WP-18 through WP-20 remain open release-tail gates.
- WP-18 internal review is recorded by #4645 / PR #5543, but #4645 remains
  ...
  follow-ups #5544-#5547. WP-21 and WP-22 are closed retained
  planning/review evidence; WP-23 remains open for release ceremony.
...
- #5544 refreshes the release-tail truth after the #4645 internal review:
  ...
  an open C-SDLC v2 terminal-artifact repair; and #5545-#5547 remain open
