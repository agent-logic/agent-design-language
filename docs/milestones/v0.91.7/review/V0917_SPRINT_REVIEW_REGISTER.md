...
| WP-07A CSM runtime rearchitecture and topology sprint | #5121 closed; remediation implemented under #5409/#5494, exact-revision review pending | `docs/reviews/v0.91.7/remaining-sprints-5403/WP07A_REARCHITECTURE_REVIEW_5121.md`; `docs/review-fixes/runtime/WP07A_REARCHITECTURE_REPAIR_5409.md` | The corrective implementation now reports the actual daemon-supervised-cycle model, derives readiness from all required component and typed-channel observations, runs a behavioral 100-cycle supervised soak with failure/recovery and replay, and provides bounded credential overlap with terminal revocation. The umbrella remains setup/topology evidence only. | Close #5409 only after #5494 exact-revision review, proving validation, merge, and lifecycle closeout. |
