...
| Paper and publication surfaces | feature-list publication/paper rows, launch planning | Operator-scope-out paper/publication work with evidence and approval so first-birthday launch evidence does not silently inherit publication claims. |
