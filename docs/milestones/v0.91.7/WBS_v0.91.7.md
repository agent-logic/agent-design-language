...
| Security/CAV/SSM/ACIP/A2A/protobuf/WebSocket/access implementation | `#4639`, `#4656`-`#4660` | Activation blockers are resolved or v0.92 remains blocked with evidence and operator approval. |
