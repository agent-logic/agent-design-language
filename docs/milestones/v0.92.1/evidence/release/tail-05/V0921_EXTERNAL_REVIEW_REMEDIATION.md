...
|---|---|---|
| P1 — mandated denominator not exercised | Superseded by executable review; two blockers returned | A clean detached review at `9c7e57d412d61898bd44ab00d53e31afbb779e5c` exercised the required validators and focused Runtime tests. It found #818 retained-proof drift and a non-current, blocked #835 release projection. These are evidence/projection blockers, not product-code defects. |
