...
require_text "infra/aws/runtime/xcl-01/main.tf" "resource \"aws_vpc_security_group_egress_rule\" \"instance_to_s3_gateway\""
require_text "infra/aws/runtime/xcl-01/main.tf" "prefix_list_id    = var.s3_prefix_list_id"
