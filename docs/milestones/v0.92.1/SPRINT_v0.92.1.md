...
3. **Sprint 2 — parallel cloud foundations (#530):** AWS-A through AWS-E and GCP-A through GCP-D advance through their provider-local ordered results; #122/#251/#84/#345 remain existing independently owned issues.
...
9. **Sprint 8 — product lanes (#536):** existing podcast #51/#261-#264/#342; Observatory OBS-A; and #251, #122, #345, plus #84 preparation may run in parallel. #84 final Unity proof consumes #251 and #122, and OBS-B consumes OBS-A plus that completed Unity/public-exposure convergence.
