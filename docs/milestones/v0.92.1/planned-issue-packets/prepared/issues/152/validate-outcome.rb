...
UMBRELLA = "INT-U"
LANE = "integration"
EXPECTED_CHILDREN = {"INT-01" => 188, "INT-02" => 189, "INT-03" => 190}.freeze
DEFERRED_CHILDREN = [].freeze
EXTERNAL_GATES = {"CORP-08" => { "issue" => 160, "before" => "INT-01" }, "V3-16" => { "issue" => 179, "before" => "INT-01" }, "DRT-07" => { "issue" => 187, "before" => "INT-01" }}.freeze
LEDGER_PATH = File.join(ROOT, "docs/milestones/v0.92.1/evidence/umbrellas/int-u/child-ledger.json")
ALLOWED_PREFIXES = [
