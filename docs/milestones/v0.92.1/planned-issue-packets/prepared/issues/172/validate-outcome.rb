...
ISSUE = 172
WORK_PACKAGE = "V3-10B"
REQUIRED_ARTIFACTS = ["csdlc-v3/src/commands/card/mod.rs", "csdlc-v3/src/commands/doctor/mod.rs", "csdlc-v3/src/commands/doctor/findings.rs", "csdlc-v3/tests/commands/card/semantic_edits.rs", "csdlc-v3/tests/commands/card/phase_optionality.rs", "csdlc-v3/tests/commands/doctor/read_only.rs", "csdlc-v3/tests/commands/doctor/next_operation.rs"].freeze
REQUIRED_LANES = {"v3-10b-focused-rust"=>["cargo", "test", "--locked", "--manifest-path", "csdlc-v3/Cargo.toml", "--all-targets"], "v3-10b-diff-hygiene"=>["git", "diff", "--check", "origin/main...HEAD"]}.freeze
EXPECTED_OBSERVATIONS = {"markdown_authority_mutation_count"=>["eq", 0], "doctor_mutation_count"=>["eq", 0], "card_family_phase_coverage_count"=>["gte", 6], "stranded_healthy_state_count"=>["eq", 0], "collapsed_blocker_kind_count"=>["eq", 0], "undeclared_placeholder_count"=>["eq", 0]}.freeze
PROOF_PATH = File.join(ROOT, ".csdlc/evidence/172/proof.json")

def fail!(message)
  abort("FAIL [V3-10B]: " + message)
end
...
puts "PASS: V3-10B exact-head artifact, producer, and invariant proof"
