...
UMBRELLA = "DRT-U"
LANE = "runtime"
EXPECTED_CHILDREN = {"DRT-01" => 181, "DRT-02" => 182, "DRT-03" => 183, "DRT-04" => 184, "DRT-05" => 185, "DRT-06" => 186, "DRT-07" => 187}.freeze
DEFERRED_CHILDREN = [].freeze
EXTERNAL_GATES = {"RUNTIME-142" => { "issue" => 142, "before" => "DRT-03" }}.freeze
LEDGER_PATH = File.join(ROOT, "docs/milestones/v0.92.1/evidence/umbrellas/drt-u/child-ledger.json")
ALLOWED_PREFIXES = [
