...
1. **Repository authority first.** #432's reviewed implementation is merged and ancestral before #431 or an execution root consumes it. Administrative closeout is asynchronous. No tracked planning artifact depends on a local untracked path.
