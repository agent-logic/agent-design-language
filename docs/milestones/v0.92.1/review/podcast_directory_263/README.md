...
- `provider-runbooks.md` records Apple Podcasts, Spotify for Creators, Amazon Music for Podcasters, and YouTube RSS-ingestion steps from official provider instructions sampled on 2026-09-01.
