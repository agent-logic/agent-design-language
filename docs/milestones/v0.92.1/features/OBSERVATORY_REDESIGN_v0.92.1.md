...
Existing `#251` TLS 1.2 and `#122` Route53/ACM exposure may execute in parallel. Existing `#84` Unity Observatory preparation may proceed concurrently, but its final proving lane must consume terminal #251 and #122 evidence. OBS-A may proceed in parallel; OBS-B waits for OBS-A and the Unity/public-exposure convergence.
