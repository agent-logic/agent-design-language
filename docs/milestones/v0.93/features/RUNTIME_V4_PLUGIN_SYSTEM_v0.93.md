...
Runtime v4 must be completed in v0.93, as explicitly directed by the operator on 2026-09-16. RV-01 through RV-11 are mandatory release scope. The prior design is not automatically approved: RV-01 must resolve its review findings before implementation admission.
