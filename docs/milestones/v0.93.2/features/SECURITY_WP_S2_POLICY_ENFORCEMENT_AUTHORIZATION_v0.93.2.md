# Security WP-S2: Policy Enforcement And Authorization v0.93.2
...
citizen/action policy enforceable under least privilege. v0.93.2 should not only
...
- v0.93.2 delegation, IAM, standing, rights, and duties models.
