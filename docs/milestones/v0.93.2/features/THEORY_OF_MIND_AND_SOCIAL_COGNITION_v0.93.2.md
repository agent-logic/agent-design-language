# v0.93.2 Theory Of Mind And Social Cognition

## Status

Forward-planning feature contract for v0.93.2. This document does not claim that
...
- v0.93.2 owns the first bounded Theory of Mind, reputation-boundary, shared
...
v0.93.2 should make Theory of Mind useful for a polis without letting it become a
...
| [IDENTITY_CONTINUITY_AND_BIRTHDAY_PLAN_v0.92.md](../../v0.92/IDENTITY_CONTINUITY_AND_BIRTHDAY_PLAN_v0.92.md) | Durable identity, capability envelope, memory grounding, and birth evidence consumed by v0.93.2 social cognition. |
| [CONSTITUTIONAL_CITIZENSHIP_AND_POLIS_GOVERNANCE_PLAN_v0.93.2.md](../DESIGN_v0.93.2.md) | Governance layer that consumes ToM without collapsing it into public verdicts. |
...
A later v0.93.2 implementation should define a versioned agent-model schema with
at least:
...
A later v0.93.2 implementation should define a signed update-event schema with at
least:
...
ToM update events are governance-relevant. In v0.93.2 they should be treated as
...
In the extracted Runtime, consuming the accepted Runtime v3 baseline and qualified v4 contracts, ToM participates in a cycle as:
...
## v0.93.2 Work Package Shape

Later v0.93.2 WP planning should split this work into bounded pieces:
...
- This document does not create a v0.93.2 issue wave.
...
Execution owners: agent-logic-runtime. Candidate results: GOV-06, GOV-07. Named people and exact repository identifiers are settled before execution. Shared contracts have one producer and versioned consumers; source is not duplicated between owners.

## Overview

- **GOV-06:** Signed evidence-backed model updates replay under standing, consent/scope and projection controls.
- **GOV-07:** Conflicting and stale entries change a bounded consumer decision through explicit uncertainty/decay events.
...
- GOV-06 follows GOV-01.
- GOV-07 follows GOV-06.
...
- GOV-06: Unsigned update; Guest scope exceeded.
- GOV-07: Conflict overwritten; Stale confidence unchanged.
...
GOV-06, GOV-07; owner repositories: agent-logic-runtime. The current execution graph supersedes older sequencing or placement in retained source text.
