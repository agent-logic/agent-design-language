...
Reconciled draft under #922. Operator-confirmed v0.93.2 scope; no implementation, milestone opening or release acceptance claimed.
...
Template: feature_doc 1.1.0. Milestone: v0.93.2. Authoring issue: #922.
...
Follow accepted v0.93.1/TAIL-10 handoff, explicit v0.93.2 opening and the pinned v0.93.1/RD-11 repository lockset. Early #922 drafting does not satisfy the predecessor handoff.
...
Consume versioned Runtime and product contracts after v0.93.1/RD-11. CM-04 is required by INTEGRATE and final QUALIFY.
...
Only explicitly excluded scope may be deferred; the admitted v0.93.2 results remain release requirements.

## Notes

EXECUTION_PLAN_v0.93.2.json is the dependency authority; FEATURE_PROOF_COVERAGE_v0.93.2.md records feature mappings.
