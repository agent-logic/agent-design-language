# v0.93.2 Feature: Guilds And Collective Organization
...
- Doc Role: primary
- Supporting Docs:
  - `docs/milestones/v0.93.2/features/CITIZENSHIP_RIGHTS_DUTIES_AND_SOCIAL_CONTRACT_v0.93.2.md`
  - `docs/milestones/v0.93.2/features/DELEGATION_IAM_STANDING_AND_APPEAL_GOVERNANCE_v0.93.2.md`
  - `docs/milestones/v0.93.2/features/SOCIAL_RELATIONSHIP_REPUTATION_AND_SHARED_MEMORY_v0.93.2.md`
...
- Demo: future v0.93.2 proof should exercise membership, authority allow/deny,
  and challenge cases.
...
- Review / Proof Surface: v0.93.2 governance review should include guild
...
`v0.95` may consume a guild baseline only if v0.93.2 produces reviewable
governance evidence for identity, membership, authority, trace, privacy, and
challenge boundaries.

## Acceptance Criteria

- The v0.93.2 feature index links this document.
- The v0.93.2 WBS names guilds as a candidate work area.
...
proof demos after v0.93.2 WP-01 finalizes the issue wave.
