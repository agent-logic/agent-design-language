...
use super::authority::{git_head, verify_canonical_v3_authority};
...
/// current checkout proves that native v3 authority is still active. This route
/// never creates a new intent and requires the single-retry recovery flag.
