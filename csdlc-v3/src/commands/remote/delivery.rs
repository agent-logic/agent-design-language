//! Verified review-to-publication delivery and terminal classification.
...
pub struct AuthorityReceipt {
    pub(super) source: AuthoritySource,
...
pub struct Verified<T> {
    pub(super) value: T,
    pub(super) receipt: AuthorityReceipt,
}
...
impl<T: VerifiableSubject> Verified<T> {
    pub(crate) fn new(
        ...
        if receipt.digest != delivery_receipt_digest(receipt.source, &subject_digest)
...
pub struct RemoteDeliveryInput {
    pub(super) pvf: Verified<AcceptedPvfResult>,
    pub(super) review: Verified<ReviewRecord>,
    pub(super) publication: Verified<PublicationRequest>,
    pub(super) pull_request: Verified<PullRequestReadback>,
    pub(super) issue: Verified<IssueReadback>,
    pub(super) cleanup: Verified<CleanupCandidate>,
}
...
pub(crate) fn receipt(source: AuthoritySource, subject_digest: &str) -> AuthorityReceipt {
    AuthorityReceipt {
        source,
        digest: delivery_receipt_digest(source, subject_digest),
...
fn delivery_receipt_digest(source: AuthoritySource, subject_digest: &str) -> String {
