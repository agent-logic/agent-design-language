...
| --- | --- | --- | --- |
| `cargo test --manifest-path adl-runtime-kernel/Cargo.toml` | PASS | `.csdlc/evidence/759/runtime-v3-fast-full-r15.log` | `fa55d84b9444f3ae96702cbb8be01f2fc30fb03d8afea9827561b1440ba123e2` |
| `cargo test --manifest-path adl-runtime-kernel/Cargo.toml dynamic_agent_health_sweep_drains_after_task -- --nocapture` | PASS | `.csdlc/evidence/759/focused-dynamic-agent-health-r15.log` | `66f30d3138fff8335a83c398e23ebd5dfc9800aace35819783ea983fe40956cb` |
| `cargo test --manifest-path adl-runtime-kernel/Cargo.toml resident_shepherd_construction_uses_configured_canonical_name_and_truthful_counts --test agent_roster -- --nocapture` | PASS | `.csdlc/evidence/759/focused-resident-shepherd-id-r15.log` | `4fbbfc368908ba0a2a9551d89c61a8ec7448daea0b15962db404e9e39577abea` |
| `cargo test --manifest-path adl-runtime-kernel/Cargo.toml unavailable_sntp_does_not_block_kernel_startup_or_erase_bootstrap_time --test assembly -- --nocapture` | PASS | `.csdlc/evidence/759/assembly-sntp-isolated-r15.log` | `124680c06b464b1874737dbef05cec70a2f8bc1c261df9c1bd1031cc4125fff9` |
| `cargo test --manifest-path adl-runtime-kernel/Cargo.toml shutdown_grace_aborts_non_cooperative_operation_executor --test assembly -- --nocapture` | PASS | `.csdlc/evidence/759/assembly-shutdown-grace-isolated-r15.log` | `c8eaadc6b557198b4f08609e3db459e358c2c29d536f704cff04f13e8b6cd1cc` |
| `cargo test --manifest-path adl-runtime-kernel/Cargo.toml pinned_vector_s3_archive_outage_emits_sink_failure_while_master_log_progresses --test observability -- --nocapture` | PASS | `.csdlc/evidence/759/observability-s3-outage-isolated-r15.log` | `eace6c62dce52168b62b59548db8b1eaa49cfd48a0571be9ec29fb416501cc1f` |
