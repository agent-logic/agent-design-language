...
### P1 - Two mapped children lack derived terminal envelopes
...
terminal envelopes for six children, but not for `#5853` or `#5822`.

The umbrella must remain open until those two closeout envelopes are derived
from current live GitHub state and the integrated review is rerun against the
complete eight-child terminal set.
...
- Derived terminal envelopes: `6/8 present`
- Missing derived terminal envelopes: `#5853`, `#5822`
- Product code changed by this umbrella: none
- Broad tests run by this umbrella: none

## Remaining Gates

1. Reconcile derived terminal envelopes for `#5853` and `#5822`.
