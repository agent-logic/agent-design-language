...
name: "validation-integrity-execution-plan"
issue: 816
task_id: "issue-0816"
run_id: "issue-0816"
version: "v0.92.1"
...
scope:
  files:
    - "OBS-B validator and Runtime config-reload tests."
  components:
    - "validation-integrity"
  out_of_scope:
    - "No redesign or broad refactor."
constraints:
  - "design_time_plan_must_be_reviewed_before_execution"
  - "runtime_execution_must_update_spp_if_plan_changes"
  - "no_hidden_scope_expansion"
confidence: "medium"
plan_summary: "Reproduce each finding; patch the narrow validator/test seam; run negative and repeated proof; obtain exact-head review; publish."
assumptions:
  - "The linked source issue prompt, STP, and SIP remain the canonical design-time inputs."
proposed_steps:
  - id: "step-1"
    description: "Confirm dependency readiness and starting state: None pending."
    expected_output: ".csdlc/issues/816/cards/sip.md"
    allowed_mode: "design_review_then_execution"
  - id: "step-2"
    description: "Review repo inputs and scoped surfaces before editing: Issue #816 and current implementation."
    expected_output: ".csdlc/issues/816/cards/stp.md"
    allowed_mode: "design_review_then_execution"
  - id: "step-3"
    description: "Implement only the bounded deliverables: Two validation integrity repairs and proof."
    expected_output: "tracked issue work product"
    allowed_mode: "execution_after_approval"
  - id: "step-4"
    description: "Run focused proof gates for acceptance: Causal positive/negative and repeated deterministic proof."
...
risks_and_edge_cases:
  - "Scheduler races and nonrepresentative fixtures."
test_strategy:
  - "Focused redaction fixtures; repeated focused Rust cancellation tests; fmt and diff check."
...
notes: "Fail closed on any noncausal proof."
---
...
Design-time operative plan for `[v0.92.1][TAIL-06.11][quality] Repair redaction and hot-reload validation integrity`.

Reproduce each finding; patch the narrow validator/test seam; run negative and repeated proof; obtain exact-head review; publish.
...
2. Review repo inputs and scoped surfaces before editing: Issue #816 and current implementation.
3. Implement only the bounded deliverables: Two validation integrity repairs and proof.
4. Run focused proof gates for acceptance: Causal positive/negative and repeated deterministic proof.
...
Fail closed on any noncausal proof.
