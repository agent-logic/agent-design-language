...
scope:
  files:
    - "adl/src/codefriend/server.rs; adl/src/bin/codefriend_server.rs; adl/src/codefriend/mod.rs; bounded runner prompt helper; adl/tests/codefriend_server.rs; docs/codefriend/SERVER.md; issue PVF manifest"
  components:
