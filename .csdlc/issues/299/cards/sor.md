...
- Diagnosed the serial full-suite RED as gate_github_actions outside the #299-owned cleanup surface: issue_read_failures_are_typed_redacted_and_action_scoped still fails in a clean isolated target with expected remote_rate_limited vs observed remote_transport, while operation_marker_is_stable_and_idempotent passes serially in its own isolated target.
...
[
  {
    ...
    "purpose": "Focused #299 archived-projection cleanup matrix after expanded restart, receipt, authority, drift, and corruption coverage; evidence log includes HEAD, argv, and status.",
    "outcome": "passed",
  ...
  },
  {
    ...
    "purpose": "Strict Rust lint proof for #299 source and tests; evidence log includes HEAD, argv, and status.",
    "outcome": "passed",
  ...
  },
  {
    ...
    "purpose": "Formatting and whitespace hygiene for the #299 worktree; evidence log includes HEAD, argv, and status for each command.",
    "outcome": "passed",
  ...
  },
  {
    ...
    "purpose": "Serial full csdlc-v2 suite attempt before review readiness; failed in gate_github_actions, not in the #299 focused cleanup surface.",
    "outcome": "failed",
  ...
  },
  {
    ...
    "purpose": "Clean isolated rerun of the gate_github_actions read-failure case from the serial full-suite RED; reproduced expected remote_rate_limited vs observed remote_transport outside #299-owned files.",
    "outcome": "failed",
  ...
  },
  {
    ...
    "purpose": "Clean isolated rerun of the gate_github_actions operation-marker case from the serial full-suite RED; passed, so the poisoned-lock symptom was not reproduced in isolation.",
    "outcome": "passed",
