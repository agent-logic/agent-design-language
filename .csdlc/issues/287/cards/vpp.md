...
Design: .csdlc/prepared/issues/287/design.md

Diagram: .csdlc/prepared/issues/287/diagram.mmd

## Selected Lanes

[
  {
    "lane": "focused-adr0071-provider-neutral-multi-agent-evidence",
    "proof_role": "Issue-local reconciliation validator for retained and terminal provider-neutral multi-agent evidence and residual gaps.",
    "acceptance_ids": [
      "AC-1",
      "AC-2",
      "AC-3",
...
- `bash .csdlc/evidence/287/validate_adr0071_provider_neutral_multi_agent_evidence.sh`
- `/Users/daniel/git/agent-design-language/.adl/bin/csdlc-v2/csdlc-validate --root . issue --issue 287`
