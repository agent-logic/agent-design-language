...
Context:
- Issue: https://github.com/agent-logic/agent-design-language/issues/1006
- PR:
- Source Issue Prompt: .git/csdlc-v3/local/invocations/worker10-1006/source-issue.md
- Docs: docs/csdlc-v3/CURRENT_AUTHORITY.md; docs/csdlc-v3/INTENT_COMMANDS.md; current issue-close and terminal contracts
- Other: none
...
outputs:
  output_card: .csdlc/issues/1006/cards/sor.md
...
- Tools allowed:
- Sandbox / approvals:
- Source issue-prompt slug: v0922-native-coordination-completion
- Required outcome type: tested_native_tooling_behavior
- Demo required: false
