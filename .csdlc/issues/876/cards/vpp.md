...
name: "876-provider-definitions-validation-plan"
issue: 876
task_id: "issue-0876"
run_id: "issue-0876"
version: "v0.92.2"
...
validation_commands:
  - "cargo test --locked --manifest-path adl/Cargo.toml provider; execute production reload, last-known-good and subsequent-dispatch cases."
failure_policy: "Stop on required proof failure, zero scenarios, stale input or shared ownership conflict; preserve evidence."
notes: "Required deterministic local provider integration/contract and focused compatibility/lint; actual outcomes belong in SOR."
---
...
- Issue goal ref: `Active issue-bound #876 implementation and passing reviewed PR goal`
...
Required deterministic local provider integration/contract and focused compatibility/lint; actual outcomes belong in SOR.
