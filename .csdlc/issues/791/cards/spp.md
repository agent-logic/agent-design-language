...
branch: "codex/791-primary-write-guard"
...
source_refs:
  - kind: "issue"
    ref: "https://github.com/agent-logic/agent-design-language/issues/791"
...
confidence: "medium"
plan_summary: "Metadata-backed preparation and retained bind identity; exact bound worktree card writes; primary terminal output in Git metadata; reject legacy and symlinked paths; validate zero residue through normal/recovery/denial flows; independent review and publication."
assumptions:
...
Design-time operative plan for `[v0.92.2][tooling] Keep native lifecycle writes out of the primary checkout`.

Metadata-backed preparation and retained bind identity; exact bound worktree card writes; primary terminal output in Git metadata; reject legacy and symlinked paths; validate zero residue through normal/recovery/denial flows; independent review and publication.
