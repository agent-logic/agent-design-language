...
name: "v0922-architecture-impact-validation-plan"
issue: 883
task_id: "issue-0883"
run_id: "issue-0883"
version: "0.92.2"
...
After accepted merged #882, pin graph schema, direction and revision semantics; validate scoped changed symbols/modules and traversal limits; implement direct/transitive impact with edge-by-edge explanations and explicit unknown outcomes; wire installed impact command and persisted findings; prove cycles, unrelated components, multiple roots, stale graph/change identity, unknown edges and bound exhaustion, with calibration and deterministic replay.
