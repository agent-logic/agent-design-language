...
Design: .csdlc/prepared/issues/5489/design.md

Diagram: .csdlc/prepared/issues/5489/diagram.mmd
...
- `/Users/daniel/git/agent-design-language/.adl/bin/csdlc-v2/csdlc-doctor --repo . --issue 5489`
- `git diff --check`
