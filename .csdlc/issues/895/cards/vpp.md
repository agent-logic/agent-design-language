...
notes: "Executed local proof covers installed prepare/approve/inspect/admit behavior; reserved staging-target rejection and collision-safe visibility; absolute-target approve/admit denial and destination containment; canonical destination-root binding and wrong-root denial; anchor/store non-ancestry; revocation, alternate-store, deleted-tail and coherent-rollback denial; lock-held admission visibility ordering; verified-byte snapshotting; concurrent-growth rejection and actual-byte accounting; manifest/redaction/symlink/collision failures; evidence/review compatibility; formatting; strict warnings; and diff hygiene. Symlink/canonical checks are path based rather than directory-handle/no-follow semantics. Full-machine rollback including the external anchor is not claimed. Interrupted local/external head update fails closed without automatic recovery. No remote publication, provider, cloud, hosting, Linux, process-kill crash injection, or full 100 MiB boundary run is claimed. Six independent reviews failed and their actionable findings are remediated locally; a distinct fresh review is required."
---
...
Executed local proof covers installed prepare/approve/inspect/admit behavior; reserved staging-target rejection and collision-safe visibility; absolute-target approve/admit denial and destination containment; canonical destination-root binding and wrong-root denial; anchor/store non-ancestry; revocation, alternate-store, deleted-tail and coherent-rollback denial; lock-held admission visibility ordering; verified-byte snapshotting; concurrent-growth rejection and actual-byte accounting; manifest/redaction/symlink/collision failures; evidence/review compatibility; formatting; strict warnings; and diff hygiene. Symlink/canonical checks are path based rather than directory-handle/no-follow semantics. Full-machine rollback including the external anchor is not claimed. Interrupted local/external head update fails closed without automatic recovery. No remote publication, provider, cloud, hosting, Linux, process-kill crash injection, or full 100 MiB boundary run is claimed. Six independent reviews failed and their actionable findings are remediated locally; a distinct fresh review is required.
