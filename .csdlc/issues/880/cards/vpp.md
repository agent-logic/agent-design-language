...
name: "880-ci-ingestion-validation-plan"
issue: 880
task_id: "issue-0880"
run_id: "issue-0880"
version: "v0.92.2"
...
validation_commands:
  - "cargo test --locked --manifest-path adl/Cargo.toml --test codefriend_ci_ingestion (planned new target); execute installed-path CI smoke job."
...
- Issue goal ref: `Create a separate issue-bound implementation goal for #880 before source edits.`
