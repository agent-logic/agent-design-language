...
Design: .csdlc/prepared/issues/5865/design.md

Diagram: .csdlc/prepared/issues/5865/diagram.mmd
...
[
  ...
  },
  {
    ...
    "proof_role": "Recompute source, command, nonzero test, artifact, negative-case, and native receipt bindings. [preexec_rejection exit=1 diagnostic_sha256=3e13f9f12418797e9dd2fdc6eba203b2988f8f87e7f1547459e3d2613d0ab646]",
    "acceptance_ids": [
      "AC-3",
      "AC-4",
      "AC-5",
...
- `cargo nextest run --manifest-path adl-runtime/Cargo.toml --test distributed_transport --no-tests=fail`
- `ruby .csdlc/prepared/issues/5865/validate-proof-receipt.rb`
