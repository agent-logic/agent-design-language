...
HTML Observatory UI/configuration, Runtime v3 observatory read/stream/write surfaces needed for controls, focused validation, and issue-local lifecycle records.
