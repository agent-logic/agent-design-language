...
- `Ran 134 focused remote, publication, operational CLI, terminal, and decomposition tests plus strict formatting and clippy`
...
verification_summary:
  validation:
    status: pass
    checks_run:
      - "134 focused tests passed; fmt, clippy -D warnings, and diff check passed"
  determinism:
    status: not_run
    replay_verified: yes
...
- Determinism tests executed: `134 deterministic local cases passed using controlled fake remote transport; no live writes`
