...
6. AC-6: Trusted custody remains outside snapshot state. Install requires exact current and every prepared custody, empty legacy fields, and complete finalized evidence reverified with live quorum/signature/time/index rules.
