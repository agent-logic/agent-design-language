...
One preparation path plus one warm two-node Terraform launch path and truthful startup measurement; no production-control-plane expansion.
...
1. AC-1: Normal launch executes no Git Rust build toolchain install OS package manager Snap mutable dependency resolution or Ollama model download
...
- agent-logic/agent-design-language#607
...
- S3 run adl-issue345-20260901-152336 timing receipts

## Non Goals

- Production HA or autoscaling
- DNS ACM Route53 or load balancers
- Multi-region or multi-AZ replication
- Spot fallback
- 24/7 production cutover
- Replacing S3 artifact authority
