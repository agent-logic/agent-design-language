...
Implemented typed exact, intentional-broad, and invalid Rust test selector classification so misleading free substring lanes fail before execution while explicit Cargo target boundaries and truthful broad lanes remain supported.
