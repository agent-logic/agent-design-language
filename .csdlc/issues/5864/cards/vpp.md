...
Design: .csdlc/prepared/issues/5864/design.md

Diagram: .csdlc/prepared/issues/5864/diagram.mmd
...
[
  ...
  },
  {
    ...
    "proof_role": "Recompute source, command, nonzero test, artifact, negative-case, and native receipt bindings. [preexec_rejection exit=1 diagnostic_sha256=bc5dd4f62eb8ccfdf69fbc46cb853e208f606684c69db2b9a3780388bc7f16ca]",
    "acceptance_ids": [
      "AC-3",
      "AC-4",
      "AC-5",
...
- `cargo nextest run --manifest-path adl-runtime/Cargo.toml --test distributed_certificates --no-tests=fail`
- `ruby .csdlc/prepared/issues/5864/validate-proof-receipt.rb`
