...
name: "v0922-four-perspective-review-validation-plan"
issue: 890
task_id: "issue-0890"
run_id: "issue-0890"
version: "0.92.2"
...
goal_metrics_rollup_ref: ".csdlc/evidence/890/goal-metrics.json (planned; absent until execution)"
source_refs:
  - kind: "issue"
...
Verify accepted CF-EVIDENCE and RT-PROVIDER revisions and contracts; implement the production four-perspective runner with identical redacted scoped evidence and isolated perspective inputs; persist attributed committed results before exposing peers and represent timeout/failure/cancel/absent-lane states; wire installed review run command and test direct/retrieved/cached peer injection, missing citations and hostile source instructions; execute controlled-provider semantic fixtures, then separately authorized actual registered OpenAI review with exact model/profile and source/candidate identities, retaining nonzero lane output and no-source-mutation proof.
