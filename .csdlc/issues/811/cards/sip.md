...
Context:
- Issue: https://github.com/agent-logic/agent-design-language/issues/811
- PR:
- Source Issue Prompt: https://github.com/agent-logic/agent-design-language/issues/811
- Docs: <docs_context>
- Other: none
...
- Tools allowed:
- Sandbox / approvals:
- Source issue-prompt slug: all-issue-closeout
- Required outcome type: tooling repair
- Demo required: no
