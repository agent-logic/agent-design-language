...
Context:
- Issue: https://github.com/agent-logic/agent-design-language/issues/856
- PR:
- Source Issue Prompt: .csdlc/evidence/856/source-issue.md
...
outputs:
  output_card: .csdlc/issues/856/cards/sor.md
...
- Tools allowed:
- Sandbox / approvals:
- Source issue-prompt slug: issue-856-native-release-preflight
- Required outcome type: tooling_repair
- Demo required: false
...
Issue #856; release_ceremony.sh; tail-02 Cargo manifest inventory; current native authority
