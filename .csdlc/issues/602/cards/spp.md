...
[
  ...
  {
    "id": "S2",
    "action": "Implement csmctl agent add, list, get, remove, dehydrate, migrate, and rehydrate with exact TLS, bearer handling, atomic artifact writes, and secret-free output.",
    "acceptance_ids": [
      "AC-1",
      "AC-3",
      "AC-4",
  ...
  {
    "id": "S3",
    "action": "Update API contracts and run focused lifecycle, persistence, artifact-tamper, roster, formatting, and lint proof.",
    "acceptance_ids": [
      "AC-1",
      "AC-2",
      "AC-3",
  ...
  {
    "id": "S4",
    "action": "Deploy the exact candidate on Wuji and prove add, duplicate, freeze-dry migration, rehydration, roster health, Shepherd preservation, and restart recovery with gemma4:e4b-mlx.",
    "acceptance_ids": [
      "AC-1",
      "AC-2",
      "AC-3",
