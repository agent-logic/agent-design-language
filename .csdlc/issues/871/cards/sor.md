...
Preparation only for [v0.92.2][SIM-05] Derived cards and precise evidence invalidation. No implementation, acceptance proof, review, publication, merge or terminal closeout has run.
...
- Issue goal ref: `active sprint goal #866 in Codex task 01a092ce-eb9e-7cb3-b7ac-fc1d46ca4788 covers child #871`
- Sprint goal ref: `issue-866`
- Goal metrics rollup ref: `.csdlc/evidence/871/goal-metrics.json (planned; absent until execution)`
- Validation planning prompt: `.csdlc/issues/871/cards/vpp.md`
...
## Artifacts produced
- Local ignored output-card scaffold at `.csdlc/issues/871/cards/sor.md`
...
- Run artifact root: `.csdlc/evidence/871 (planned)`
...
- Primary proof surface: `.csdlc/evidence/871 (planned)`
...
- `Dependency #870 merged and closed with native terminal reconciliation before #871 binding.`
- `Use the active pre-conversion native owner for this legacy prepared record; the merged semantic candidate remains isolated and does not replace or activate the shared writer.`

## Follow-ups / Deferred work
- `Bind natively, recheck shared-path ownership, then begin the bounded #871 implementation.`
