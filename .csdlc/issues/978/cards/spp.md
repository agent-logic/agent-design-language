...
run_id: "issue-0978"
version: "1.0.5"
title: "[v0.92.2][RT-PROVIDER][corrective] Make managed Runtime startup and provider admission resilient"
branch: "codex/978-runtime-startup-provider-resilience"
...
source_refs:
  - kind: "issue"
    ref: "https://github.com/agent-logic/agent-design-language/issues/978"
...
Design-time operative plan for `[v0.92.2][RT-PROVIDER][corrective] Make managed Runtime startup and provider admission resilient`.
