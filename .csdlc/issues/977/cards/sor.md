...
Run ID: issue-0977
Version: v0.92.2
Title: [RD-01] Execute repository dependency and ownership audit
Branch: codex/977-rd01-repository-audit
Card Status: ready
Status: in_progress
Generated: <timestamp>
...
Audit executed at f69019c24a9b61511e912c93f95442f96fa66d92: 31813 tracked paths, 9466 unresolved owner decisions, 211 manifest/module paths, 310 Cargo declarations. Isolated UTS20/provider107 pass; CSDLC owned bundle builds, lib122 pass/2 fail on authority context. Required extraction gates remain unresolved. Independent audit review findings addressed.
...
- Validation commands and their purpose:
  - `python3 adl/tools/rd01_repository_audit.py --self-test; python3 adl/tools/rd01_repository_audit.py --verify; retained isolated probe matrix in rd01-977/probe-results.json`
    `<validation_effect>`
- Results:
  - `Audit executed at f69019c24a9b61511e912c93f95442f96fa66d92: 31813 tracked paths, 9466 unresolved owner decisions, 211 manifest/module paths, 310 Cargo declarations. Isolated UTS20/provider107 pass; CSDLC owned bundle builds, lib122 pass/2 fail on authority context. Required extraction gates remain unresolved. Independent audit review findings addressed.`
...
- Primary proof surface: `docs/milestones/v0.92.2/repository-decomposition/rd01-977/AUDIT.md; docs/milestones/v0.92.2/evidence/rd01-977/summary.json`
