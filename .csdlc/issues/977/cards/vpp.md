...
validation_resource_profile: "Bounded local CPU/disk, offline dependency cache; no paid/live provider effects."
...
- Validation resource profile: `Bounded local CPU/disk, offline dependency cache; no paid/live provider effects.`
- Validation family: `<validation_family>`
- Validation size split: `<validation_size_split>`

## Goal Accounting Hooks

- Issue goal ref: `issue-977`
