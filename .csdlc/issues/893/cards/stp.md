...
wp: "CF-REMEDIATE"
slug: "v0922-remediation-planner"
...
repo_inputs:
  - "https://github.com/agent-logic/agent-design-language/issues/893"
canonical_files: []
demo_required: true
demo_names: []
issue_graph_notes:
  - "#892 dependency satisfied before #893 implementation. #893 consumes synthesis-shaped output and remains bounded to local remediation-plan generation/reading."
pr_start:
  enabled: true
  slug: "v0922-remediation-planner"
---
...
#892 (CF-SYNTHESIS) is terminal and available as the accepted predecessor output for this implementation. #893 remains scoped to remediation-plan generation and does not implement repairs or GitHub issue creation.
