...
V3-C lifecycle transition model, transaction storage/recovery model, typed adapters, crate-local AGENTS.md guidance, focused transaction tests, and issue-local evidence only.
