...
source_refs:
  ...
  - kind: "spp"
    ref: "<spp_card>"
selected_lanes:
  - "command-help; authenticated-authority; cross-surface-fitness"
parallel_groups:
  - "<parallel_groups_inline>"
validation_commands:
  - "<validation_commands_inline>"
failure_policy: "Fail on authority authentication drift, contradictory current surface, modified historical record, or non-proving regression."
...
- Fail on authority authentication drift, contradictory current surface, modified historical record, or non-proving regression.
