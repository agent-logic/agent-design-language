...
Context:
- Issue: https://github.com/agent-logic/agent-design-language/issues/843
- PR:
- Source Issue Prompt: https://github.com/agent-logic/agent-design-language/issues/843
- Docs: Native C-SDLC v3 GitHub remote mutation tooling.
- Other: none
...
outputs:
  output_card: .csdlc/issues/843/cards/sor.md
...
- Tools allowed:
- Sandbox / approvals:
- Source issue-prompt slug: legacy-ready-intent-recovery
- Required outcome type: tooling defect repair
- Demo required: false
...
Issue #843 and preserved #835 reproduction.
