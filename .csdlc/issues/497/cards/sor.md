...
- Removed the tracked PR-state readback JSON from the exact-head artifact set because any committed PR-state file that embeds head_sha necessarily becomes stale when the commit containing it is pushed.
- Preserved exact PR-body/linkage proof as live typed PR-state observation during review and final verification rather than as a self-staling tracked artifact.
...
[
  ...
  },
  {
    ...
    "purpose": "Prove CORP-C machine-readable evidence files and PR request records parse as JSON.",
    "outcome": "passed",
  ...
  },
  {
    ...
    "purpose": "Prove scoped #497 card, evidence, and PR request surfaces no longer contain GitHub closing-keyword syntax for #497.",
    "outcome": "passed",
  ...
  },
  {
    ...
    "purpose": "Observe live PR #613 body/linkage at review/final-verification time without committing a self-staling head_sha-bearing readback file.",
    "outcome": "passed",
    "evidence_ref": "Live typed PR-state observation reported linkage_source null and linked_issue null."
  },
  {
    "command": [
      "csdlc-doctor",
