...
wp: "QUAL-PROVIDER"
slug: "v0922-provider-recovery-qualification"
...
required_outcome_type:
  - "executed_production_qualification"
repo_inputs:
  - "https://github.com/agent-logic/agent-design-language/issues/901"
canonical_files: []
demo_required: true
demo_names: []
issue_graph_notes:
  - "#855 (RT-PROVIDER) accepted merged output is required and not satisfied in this preparation. #852 is not an added graph prerequisite; any consumed WSS event evidence must nevertheless come from its accepted producer output."
pr_start:
  enabled: true
  slug: "v0922-provider-recovery-qualification"
---
