...
notes: "Local accounting/negative gate implemented and run; observational actual raw PAIR/Runtime/node-loss gates not run. PAIR supports compatible macOS/Linux/Windows nodes; two approved nodes and exact model/transport/resource choices remain unresolved. No new provider type or production provider policy change."
---
...
Local accounting/negative gate implemented and run; observational actual raw PAIR/Runtime/node-loss gates not run. PAIR supports compatible macOS/Linux/Windows nodes; two approved nodes and exact model/transport/resource choices remain unresolved. No new provider type or production provider policy change.
