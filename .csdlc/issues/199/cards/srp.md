...
- Does retained v8 proof bind twelve behavior-specific cases, eight production assertions, protected-source drift, immutable evidence, strict Clippy, and current-main ancestry?
