...
Context:
- Issue: https://github.com/agent-logic/agent-design-language/issues/844
- PR:
- Source Issue Prompt: https://github.com/agent-logic/agent-design-language/issues/844
- Docs: docs/csdlc-v3/PULL_REQUEST_MERGE.md
- Other: none
...
outputs:
  output_card: .csdlc/issues/844/cards/sor.md
...
- Tools allowed:
- Sandbox / approvals:
- Source issue-prompt slug: issue-844-native-pr-merge
...
Issue844 and native remote mutation/terminal contracts
