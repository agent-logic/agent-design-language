...
[
  {
    "id": "S1",
    "action": "Review and approve the namespace, identity, immutable-ledger, restart, and cleanup protocol.",
    "acceptance_ids": [
      "AC-1",
      "AC-3",
      "AC-4",
  ...
  {
    "id": "S2",
    "action": "Implement typed classify, recover, restart, audit, and separate cleanup operations under the issue lock.",
    "acceptance_ids": [
      "AC-2",
      "AC-5"
    ],
  ...
  {
    "id": "S3",
    "action": "Add real projection integration, failpoint, collision, race, corruption, topology, CAS, idempotency, and regression proof.",
    "acceptance_ids": [
      "AC-8"
    ],
    "status": "pending"
  ...
  {
    "id": "S4",
    "action": "Validate, independently exact-head review, publish ready, and shepherd required CI without merge.",
    "acceptance_ids": [
      "AC-9"
    ],
    "status": "pending"
