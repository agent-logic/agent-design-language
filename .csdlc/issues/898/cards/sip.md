...
Context:
- Issue: https://github.com/agent-logic/agent-design-language/issues/898
- PR:
- Source Issue Prompt: https://github.com/agent-logic/agent-design-language/issues/898
...
outputs:
  output_card: .csdlc/issues/898/cards/sor.md
...
- Tools allowed:
- Sandbox / approvals:
- Source issue-prompt slug: v0922-codefriend-pdf-renderer
...
Execution prerequisite: #896 (CF-RENDER-MD); accepted output is required before dependent execution.
