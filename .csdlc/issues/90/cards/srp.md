...
Issue #90 request/report contract, migration authorization, atomic state and audit behavior, CLI/schema integration, focused tests, publication regression, and operator recovery documentation.
