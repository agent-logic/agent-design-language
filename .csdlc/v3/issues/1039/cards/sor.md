...
Issue prepared; implementation, proof, review, publication, CI, merge, finish, and cleanup remain pending.
...
- Tracked implementation artifacts: `Pending implementation in the bound #1039 FastWork worktree.`
...
- Validation commands and their purpose:
  - `cargo test --manifest-path csdlc-v3/Cargo.toml cleanup_preview_execute_accepts_stale_generated_projection`
    `Will prove cleanup preview/execute parity and retained fail-closed guards.`
- Results:
  - `Not run.`
