...
Context:
- Issue: https://github.com/agent-logic/agent-design-language/issues/1046
- PR:
- Source Issue Prompt: https://github.com/agent-logic/agent-design-language/issues/1046
- Docs: <docs_context>
- Other: none
