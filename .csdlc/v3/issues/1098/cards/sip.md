...
Context:
- Issue: https://github.com/agent-logic/agent-design-language/issues/1098
- PR:
...
Index content and working content can differ. Retry reservation is not retry outcome.
