...
- Additional proof artifacts: `.csdlc/evidence/1090/validation.md`
...
- Validation commands and their purpose:
  - `cargo test --manifest-path csdlc-v3/Cargo.toml issue_1090`
    `Pending focused terminal selection and replay proof.`
- Results:
  - `not_run`
