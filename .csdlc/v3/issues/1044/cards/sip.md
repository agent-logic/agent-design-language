...
Context:
- Issue: https://github.com/agent-logic/agent-design-language/issues/1044
- PR:
- Source Issue Prompt: https://github.com/agent-logic/agent-design-language/issues/1044
- Docs: <docs_context>
- Other: none
