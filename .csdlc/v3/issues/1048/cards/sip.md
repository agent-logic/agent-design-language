...
Context:
- Issue: https://github.com/agent-logic/agent-design-language/issues/1048
- PR:
- Source Issue Prompt: https://github.com/agent-logic/agent-design-language/issues/1048
- Docs: <docs_context>
- Other: none
...
- Tools allowed:
- Sandbox / approvals:
- Source issue-prompt slug: publication-metadata-amendment
