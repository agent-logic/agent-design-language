...
- Additional proof artifacts: `.csdlc/evidence/1029/validation.md`
...
- Validation commands and their purpose:
  - `cargo test --manifest-path csdlc-v3/Cargo.toml issue_1029`
    `Pending focused native-v3 compatibility proof.`
- Results:
  - `not_run`
