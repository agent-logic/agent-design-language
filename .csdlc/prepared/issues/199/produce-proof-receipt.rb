...
subassertions = integration.lines.filter_map do |line|
...
assertions = all_text.lines.filter_map do |line|
...
proof = {
  ...
  "commands" => commands,
  "test_summary" => { "integration_cases" => 36, "integration_passed" => 36, "discriminator_subassertions" => 1, "source_assertions" => 5 },
