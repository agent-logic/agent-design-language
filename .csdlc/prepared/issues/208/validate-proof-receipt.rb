...
PROOF_RELATIVE = ".csdlc/evidence/208/v2/execution-proof.json"
...
fail_receipt("schema/issue mismatch") unless proof["schema"] == "adl.issue208.guardian_kernel_continuity_proof.v2" && proof["issue"] == 208
