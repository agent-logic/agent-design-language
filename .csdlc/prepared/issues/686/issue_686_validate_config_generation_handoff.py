...
def main() -> None:
    ...
    require_regex(
        ...
        (
            ...
            r"digest\.update\(content_sha256\.as_bytes\(\)\).*digest\.update\(compatible_binary_generation\.as_bytes\(\)\)",
    ...
    require(
        ...
        (
            ...
            "provision_config_generation(&init, \"runtime-generation-two\")",
            "activate_config_generation(&init, &generation_two)",
            "validate_active_config_generation(&init, \"runtime-generation-two\")",
            "activate_config_generation(&init, &generation_one)",
