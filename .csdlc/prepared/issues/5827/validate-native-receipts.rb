...
expected_workflow_prefix = "agent-logic/agent-design-language/.github/workflows/wp10-native-birthday-continuity.yml@"
...
required_tests = %w[
  continuity_record_replays_identically_across_two_signed_cycles
  missing_or_reordered_cycle_fails_closed
  forged_witness_and_identity_substitution_fail_closed
  copied_state_and_host_paths_fail_closed
