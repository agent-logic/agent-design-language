...
for fixture in negative-empty negative-self-authored-base negative-omitted-live-pr negative-incomplete-pagination negative-jointly-truncated negative-jointly-omitted-acceptance negative-content-free-lane; do
