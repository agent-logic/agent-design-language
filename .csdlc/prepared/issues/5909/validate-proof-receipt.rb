...
ISSUE_EVIDENCE_PREFIX = ".csdlc/evidence/5909/"
MACHINE_MARKER = "ADL_NEGATIVE_CASE_V1 "

def fail_receipt(message)
  abort "issue 5909 receipt: #{message}"
end
...
fail_receipt("execution proof issue mismatch") unless proof["issue"] == 5909
...
fail_receipt("machine evidence issue mismatch") unless machine["issue"] == 5909
...
fail_receipt("producer path mismatch") unless
  producer_path == ".csdlc/evidence/5909/derive-negative-cases.rb"
