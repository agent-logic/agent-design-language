...
for fixture in negative-vacuous negative-self-authored-scope negative-omitted-internal-ref negative-synthetic-local-predecessor negative-unvalidated-internal-packet; do
