...
against Runtime HTTPS/WSS; the issue-local Ruby coordinator launches the
approved Unity Editor/player against that same revision and captures native
interaction evidence; and
`adl/tools/validate_v092_observatory_restart_reconnect.mjs` coordinates a
