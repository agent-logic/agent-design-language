...
ISSUES = [5340, 5341, 5342, 5349].freeze
...
if failures.empty?
  puts JSON.generate(status: "ready", issues: ISSUES, final_gate: 5349)
  exit 0
end

puts JSON.generate(status: "waiting", issues: ISSUES, final_gate: 5349, blockers: failures)
exit 3
