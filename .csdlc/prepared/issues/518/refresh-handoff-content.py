...
result = {"schema": "adl.tail02.handoff_content.v1", "merged_baseline": "f61deb36d5eccb4a3e391510bbea4bb6f2d51216", "scope": "Original audit union all tracked README-prefixed files, AGENTS.md, REVIEW.md, Cargo.toml, v0.92.1 milestone Markdown/YAML, packet inputs and validators. Excludes this manifest and derived validation results to prevent hash cycles. Typed review separately binds the exact commit.", "documents": [{"path": p, "sha256": hashlib.sha256((root / p).read_bytes()).hexdigest()} for p in sorted(paths)]}
