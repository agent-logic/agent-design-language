...
Dir.mktmpdir("issue-522-production-",File.expand_path("../../../../.adl",__dir__)) do |repo|
 Dir.chdir(repo) do
  ...
  disposition={"kind"=>"fixed","source_finding_ids"=>INTERNAL_FINDING_IDS + EXTERNAL_FINDING_IDS + RETURNED_FINDING_IDS,"resolution"=>"All fixture findings are resolved by the declared immutable remediation set.","release_consequence"=>"No fixture release blocker remains.","remediations"=>remediations}
