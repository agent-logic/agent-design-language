...
for fixture in negative-empty negative-undispositioned negative-invented-census negative-stale-review negative-false-validation negative-altered-finding-content negative-deferred-source-blocker negative-unmerged-source negative-pass-with-findings negative-local-only-remediation-evidence negative-invalid-severity; do
